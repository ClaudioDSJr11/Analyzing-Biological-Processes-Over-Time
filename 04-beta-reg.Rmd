...
Script and data [here!](https://github.com/ClaudioDSJr11/Analyzing-Biological-Processes-Over-Time/blob/main/hands_on_material.zip)
...
- Get predicted curves and check then. Check both at the link scale (pred_df3\$pred_l) and response scale (pred_df3\$pred_p).
